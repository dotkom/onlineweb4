            ...
            success: function(data) {
                if(data.articles.length > 0) {
                    ...
                    for (var i = 0; i < data.articles.length; i++) {
                        if (i <= 1)
                            output_featured += '<div class="span6"><a href="/article/'+data.articles[i].id+'/'+data.articles[i].slug+'"><img src="'+data.articles[i].image_article_front_featured+'" alt="'+data.articles[i].heading+'"><h3>'+data.articles[i].heading+'</h3></a><p>'+data.articles[i].ingress+'</p></div>';
                        else
