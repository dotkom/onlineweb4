...
class WikiViewSet(viewsets.GenericViewSet, mixins.RetrieveModelMixin, mixins.ListModelMixin):
    ...
    def get_object(self):
        ...
        try:
            urlpath: models.URLPath = models.URLPath.get_by_path(path, select_related=True)
            return urlpath
