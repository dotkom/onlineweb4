...
from apps.feedback import tasks
...
class SimpleTest(FeedbackTestCaseMixin, TestCase):
    def test_users_mail_addresses(self):
        ...
        message = tasks.generate_message(feedback_relation, self.logger)
    ...
    def test_committee_mails(self):
        ...
        email = feedback_relation.content_email()
    ...
    def test_date(self):
        feedback_relation = self.create_feedback_relation()
        date = feedback_relation.content_end_date().date()
    ...
    def test_mark_setting(self):
        ...
        tasks.set_marks("test_title", users)
