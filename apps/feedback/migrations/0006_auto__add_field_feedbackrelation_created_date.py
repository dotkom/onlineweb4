...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeedbackRelation.created_date'
        db.add_column(u'feedback_feedbackrelation', 'created_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 17, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeedbackRelation.created_date'
        db.delete_column(u'feedback_feedbackrelation', 'created_date')
