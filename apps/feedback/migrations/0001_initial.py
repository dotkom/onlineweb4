...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={"permissions": (("view_choice", "View Choice"),)},
            bases=(models.Model,),
        ),
        migrations.CreateModel(
            name="Feedback",
            fields=[
                ...
                (
                    "description",
                    models.CharField(max_length=100, verbose_name="beskrivelse"),
                ),
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Vis studie oversikt",
                    ),
                ),
                (
                    "display_info",
                    models.BooleanField(
                        default=True,
                        help_text="En boks med ekstra informasjon vil bli vist til bedriften",
                        verbose_name="Vis extra informasjon",
                    ),
                ),
                (
                    "author",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "feedback",
                    models.ForeignKey(
                        verbose_name="Tilbakemeldingskjema",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "label",
                    models.CharField(max_length=256, verbose_name="Sp\xf8rsm\xe5l"),
                ),
            ],
            options={
                "permissions": (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order",
                    models.SmallIntegerField(default=30, verbose_name="Rekkef\xf8lge"),
                ),
                (
                    "display",
                    models.BooleanField(default=True, verbose_name="Vis til bedrift"),
                ),
                (
                    "feedback",
                    models.ForeignKey(
                ...
                (
                    ...
                    models.ForeignKey(
                        to="feedback.MultipleChoiceQuestion", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={"permissions": (("view_ratinganswer", "View RatingAnswer"),)},
            bases=(models.Model,),
        ),
        migrations.CreateModel(
            name="RatingQuestion",
            fields=[
                ...
                (
                    "order",
                    models.SmallIntegerField(default=20, verbose_name="Rekkef\xf8lge"),
                ),
                (
                    "label",
                    models.CharField(max_length=256, verbose_name="Sp\xf8rsm\xe5l"),
            ...
            options={"permissions": (("view_ratingquestion", "View RatingQuestion"),)},
            bases=(models.Model,),
        ),
        migrations.CreateModel(
            name="RegisterToken",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order",
                    models.SmallIntegerField(default=10, verbose_name="Rekkef\xf8lge"),
                ),
                (
                    "label",
                    models.CharField(max_length=256, verbose_name="Sp\xf8rsm\xe5l"),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                related_name="answer",
                to="feedback.MultipleChoiceRelation",
                on_delete=models.CASCADE,
            ),
            preserve_default=True,
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="feedback.MultipleChoiceQuestion",
                on_delete=models.CASCADE,
            ),
            preserve_default=True,
        ),
