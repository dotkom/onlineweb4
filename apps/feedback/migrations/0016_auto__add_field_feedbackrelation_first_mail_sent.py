...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeedbackRelation.first_mail_sent'
        db.add_column(u'feedback_feedbackrelation', 'first_mail_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeedbackRelation.first_mail_sent'
        db.delete_column(u'feedback_feedbackrelation', 'first_mail_sent')
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 17, 0, 0)'}),
