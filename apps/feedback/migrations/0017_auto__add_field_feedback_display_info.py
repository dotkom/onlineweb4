...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feedback.display_info'
        db.add_column(u'feedback_feedback', 'display_info',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feedback.display_info'
        db.delete_column(u'feedback_feedback', 'display_info')
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 22, 0, 0)'}),
        ...
        u'feedback.feedback': {
            ...
            'display_info': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'feedback.feedbackrelation': {
            ...
            'first_mail_sent': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
