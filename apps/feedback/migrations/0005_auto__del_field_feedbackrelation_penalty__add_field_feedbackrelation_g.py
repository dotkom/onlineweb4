...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'feedback_feedbackrelation', 'penalty')

        # Adding field 'FeedbackRelation.gives_mark'
        db.add_column(u'feedback_feedbackrelation', 'gives_mark',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'feedback_feedbackrelation', 'penalty',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'FeedbackRelation.gives_mark'
        db.delete_column(u'feedback_feedbackrelation', 'gives_mark')
