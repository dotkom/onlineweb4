...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeedbackRelation.active'
        db.add_column(u'feedback_feedbackrelation', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeedbackRelation.active'
        db.delete_column(u'feedback_feedbackrelation', 'active')
