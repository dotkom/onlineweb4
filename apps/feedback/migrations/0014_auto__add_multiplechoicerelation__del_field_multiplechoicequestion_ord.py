...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MultipleChoiceRelation'
        db.create_table(u'feedback_multiplechoicerelation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('multiple_choice_relation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feedback.MultipleChoiceQuestion'])),
        ...
        db.send_create_signal(u'feedback', ['MultipleChoiceRelation'])

        # Deleting field 'MultipleChoiceQuestion.order'
        db.delete_column(u'feedback_multiplechoicequestion', 'order')

        # Deleting field 'MultipleChoiceQuestion.feedback'
        db.delete_column(u'feedback_multiplechoicequestion', 'feedback_id')


        # Changing field 'MultipleChoiceAnswer.question'
        db.alter_column(u'feedback_multiplechoiceanswer', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feedback.MultipleChoiceRelation']))

    def backwards(self, orm):
        # Deleting model 'MultipleChoiceRelation'
        db.delete_table(u'feedback_multiplechoicerelation')

        # Adding field 'MultipleChoiceQuestion.order'
        db.add_column(u'feedback_multiplechoicequestion', 'order',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=30),
                      keep_default=False)

        # Adding field 'MultipleChoiceQuestion.feedback'
        db.add_column(u'feedback_multiplechoicequestion', 'feedback',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='multiple_choice_questions', to=orm['feedback.Feedback']),
                      keep_default=False)


        # Changing field 'MultipleChoiceAnswer.question'
        db.alter_column(u'feedback_multiplechoiceanswer', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feedback.MultipleChoiceQuestion']))
