...
class EventTest(TestCase):
    ...
    def testFieldOfStudyRule(self):
        ...
        self.assertEqual(unicode(self.fosrule), u"Bachelor i Informatikk etter 24 timer")
        self.rulebundle = G(RuleBundle, description='')
        self.rulebundle.field_of_study_rules.add(self.fosrule)
        self.assertEqual(unicode(self.rulebundle), "Bachelor i Informatikk etter 24 timer")
