...
class ArrkomEventAdminTestCase(EventAdminTestCase):
    ...
    def test_cannot_show_event_attendance_list_for_bedkom(self):
    ...
    def test_cannot_show_event_detail_admin_for_bedkom(self):
    ...
    def test_cannot_show_event_detail_dashboard_for_bedkom(self):
        event = generate_event(TYPE_CHOICES[1][0])
...
class BedkomEventAdminTestCase(EventAdminTestCase):
    ...
    def test_cannot_show_event_attendance_list_for_fagkom(self):
    ...
    def test_cannot_show_event_detail_admin_for_fagkom(self):
    ...
    def test_cannot_show_event_detail_dashboard_for_fagkom(self):
        event = generate_event(TYPE_CHOICES[2][0])
