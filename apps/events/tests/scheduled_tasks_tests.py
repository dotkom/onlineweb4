...
class EventTest(TestCase):
    ...
    def test_mommy_active_events(self):
        ...
        self.assertEqual(self.attendance_event, tasks.active_events()[0])
    ...
    def test_mommy_marks_has_been_set(self):
        ...
        self.assertFalse(tasks.active_events())
    ...
    def test_mommy_set_marks(self):
        ...
        tasks.set_marks(self.attendance_event)
    ...
    def test_mommy_generate_empty_message(self):
        ...
        message = tasks.generate_message(self.attendance_event)
