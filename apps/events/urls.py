...
router.register('user-attendance-events', views.UserAttendanceEventViewSet, base_name='user_attendance_events')
router.register('user-attendees', views.UserAttendeeViewSet, base_name='user_attendees')
