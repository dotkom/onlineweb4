...
class CaptchaForm(forms.Form):
    ...
    note = forms.CharField(label=_('Som gjest ønsker vi at du oppgir din tilhørighet til Online og annen ' \
                                   'tilleggsinformasjon som f.eks. hvem du ønsker å sitte med.'),
