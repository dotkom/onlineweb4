...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_ruleoffset', 'offset', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, max_length=3))

    def backwards(self, orm):

        # Changing field 'RuleOffset.offset'
        db.alter_column(u'events_ruleoffset', 'offset', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=4, unique=True))
    ...
    models = {
        ...
        u'events.ruleoffset': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'offset': ('django.db.models.fields.PositiveIntegerField', [], {'unique': 'True', 'max_length': '3'})
        },
