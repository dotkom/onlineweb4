...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rule.offset'
        db.alter_column('events_rule', 'offset_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.RuleOffset'], null=True))

    def backwards(self, orm):

        # Changing field 'Rule.offset'
        db.alter_column('events_rule', 'offset_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['events.RuleOffset']))
