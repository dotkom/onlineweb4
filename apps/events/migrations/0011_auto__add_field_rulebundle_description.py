...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RuleBundle.description'
        db.add_column(u'events_rulebundle', 'description',
                      self.gf('django.db.models.fields.CharField')(default='Bundle', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RuleBundle.description'
        db.delete_column(u'events_rulebundle', 'description')
