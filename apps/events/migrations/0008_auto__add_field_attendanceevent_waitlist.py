...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AttendanceEvent.waitlist'
        db.add_column('events_attendanceevent', 'waitlist',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AttendanceEvent.waitlist'
        db.delete_column('events_attendanceevent', 'waitlist')
