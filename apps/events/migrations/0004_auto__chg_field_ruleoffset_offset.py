...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_ruleoffset', 'offset', self.gf('django.db.models.fields.PositiveSmallIntegerField')(unique=True, max_length=4))
    ...
    models = {
        ...
        u'events.ruleoffset': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'offset': ('django.db.models.fields.PositiveSmallIntegerField', [], {'unique': 'True', 'max_length': '4'})
        },
