...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserGroupRule.group'
        db.add_column(u'events_usergrouprule', 'group',
    ...
    def backwards(self, orm):
        # Deleting field 'UserGroupRule.group'
        db.delete_column(u'events_usergrouprule', 'group_id')
    ...
    models = {
        ...
        u'events.usergrouprule': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['auth.Group']"}),
            u'rule_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['events.Rule']", 'unique': 'True', 'primary_key': 'True'})
        }
    }
