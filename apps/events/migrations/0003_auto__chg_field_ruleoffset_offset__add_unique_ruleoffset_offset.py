...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RuleOffset.offset'
        db.alter_column(u'events_ruleoffset', 'offset', self.gf('django.db.models.fields.PositiveSmallIntegerField')(unique=True))
        # Adding unique constraint on 'RuleOffset', fields ['offset']
        db.create_unique(u'events_ruleoffset', ['offset'])


    def backwards(self, orm):
        # Removing unique constraint on 'RuleOffset', fields ['offset']
        db.delete_unique(u'events_ruleoffset', ['offset'])


        # Changing field 'RuleOffset.offset'
        db.alter_column(u'events_ruleoffset', 'offset', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 24, 0, 0)'}),
        ...
        u'events.ruleoffset': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'offset': ('django.db.models.fields.PositiveSmallIntegerField', [], {'unique': 'True'})
        },
