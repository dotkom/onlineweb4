...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_rulebundle_field_of_study_rules', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rulebundle', models.ForeignKey(orm['events.rulebundle'], null=False)),
            ('fieldofstudyrule', models.ForeignKey(orm['events.fieldofstudyrule'], null=False))
        ))
        db.create_unique('events_rulebundle_field_of_study_rules', ['rulebundle_id', 'fieldofstudyrule_id'])

        # Adding M2M table for field grade_rules on 'RuleBundle'
        db.create_table('events_rulebundle_grade_rules', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rulebundle', models.ForeignKey(orm['events.rulebundle'], null=False)),
            ('graderule', models.ForeignKey(orm['events.graderule'], null=False))
        ))
        db.create_unique('events_rulebundle_grade_rules', ['rulebundle_id', 'graderule_id'])
