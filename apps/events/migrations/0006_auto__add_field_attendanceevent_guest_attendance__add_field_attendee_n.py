...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AttendanceEvent.guest_attendance'
        db.add_column(u'events_attendanceevent', 'guest_attendance',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Attendee.note'
        db.add_column(u'events_attendee', 'note',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AttendanceEvent.guest_attendance'
        db.delete_column(u'events_attendanceevent', 'guest_attendance')

        # Deleting field 'Attendee.note'
        db.delete_column(u'events_attendee', 'note')
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 7, 0, 0)'}),
