    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "deadline",
                    models.DateTimeField(null=True, verbose_name="frist", blank=True),
                ),
                (
                    "instant_payment",
                    models.BooleanField(
                        default=False,
                        help_text="krev betaling f\xf8r p\xe5melding",
                        verbose_name="betaling f\xf8r p\xe5melding",
                    ),
                ),
                (
                    "description",
                    models.CharField(
                        help_text="Dette feltet kreves kun dersom det er mer enn en betaling",
                        max_length=60,
                        null=True,
