...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'payment_payment', (
            ...
            ('instant_payment', self.gf('django.db.models.fields.BooleanField')()),
            ...
            ('last_changed_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authentication.OnlineUser'])),
        ))
        db.send_create_signal(u'payment', ['Payment'])

        # Adding model 'PaymentRelation'
        db.create_table(u'payment_paymentrelation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'payment', ['PaymentRelation'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PaymentRelation'
        db.delete_table(u'payment_paymentrelation')
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 4, 0, 0)'}),
        ...
        u'payment.payment': {
            ...
            'last_changed_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['authentication.OnlineUser']"}),
