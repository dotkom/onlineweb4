...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'payment_payment', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'payment_payment', 'description')
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 18, 0, 0)'}),
