...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentRelation.unique_id'
        db.add_column(u'payment_paymentrelation', 'unique_id',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentRelation.unique_id'
        db.delete_column(u'payment_paymentrelation', 'unique_id')
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 24, 0, 0)'}),
        ...
        u'payment.paymentrelation': {
            ...
            'unique_id': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
