...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Privacy.expose_phone_number'
        db.delete_column(u'profiles_privacy', 'expose_phone_number')


    def backwards(self, orm):
        # Adding field 'Privacy.expose_phone_number'
        db.add_column(u'profiles_privacy', 'expose_phone_number',
                      self.gf('django.db.models.fields.CharField')(default=True, max_length=20),
                      keep_default=False)
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 19, 0, 0)'}),
