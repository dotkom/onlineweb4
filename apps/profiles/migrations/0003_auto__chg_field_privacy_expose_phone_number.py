...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Privacy.expose_phone_number'
        db.alter_column(u'profiles_privacy', 'expose_phone_number', self.gf('django.db.models.fields.BooleanField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Privacy.expose_phone_number'
        db.alter_column(u'profiles_privacy', 'expose_phone_number', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'profiles.privacy': {
            ...
            'expose_phone_number': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'max_length': '20'}),
