...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'profiles_privacy', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('visible_for_other_users', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='privacy', unique=True, to=orm['authentication.OnlineUser'])),
        ))
        db.send_create_signal(u'profiles', ['Privacy'])


    def backwards(self, orm):
        # Deleting model 'Privacy'
        db.delete_table(u'profiles_privacy')
