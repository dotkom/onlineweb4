...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Privacy.expose_first_name'
        db.delete_column(u'profiles_privacy', 'expose_first_name')

        # Deleting field 'Privacy.expose_last_name'
        db.delete_column(u'profiles_privacy', 'expose_last_name')

        # Deleting field 'Privacy.expose_started_date'
        db.delete_column(u'profiles_privacy', 'expose_started_date')

        # Deleting field 'Privacy.expose_field_of_study'
        db.delete_column(u'profiles_privacy', 'expose_field_of_study')

        # Deleting field 'Privacy.expose_compiled'
        db.delete_column(u'profiles_privacy', 'expose_compiled')


    def backwards(self, orm):
        # Adding field 'Privacy.expose_first_name'
        db.add_column(u'profiles_privacy', 'expose_first_name',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Privacy.expose_last_name'
        db.add_column(u'profiles_privacy', 'expose_last_name',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Privacy.expose_started_date'
        db.add_column(u'profiles_privacy', 'expose_started_date',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Privacy.expose_field_of_study'
        db.add_column(u'profiles_privacy', 'expose_field_of_study',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Privacy.expose_compiled'
        db.add_column(u'profiles_privacy', 'expose_compiled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
