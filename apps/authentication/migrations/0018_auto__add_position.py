...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'authentication_position', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start_year', self.gf('django.db.models.fields.CharField')(default=2013, max_length=4)),
            ('end_year', self.gf('django.db.models.fields.CharField')(default=2014, max_length=4, blank=True)),
            ('present', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('committee', self.gf('django.db.models.fields.CharField')(default='hs', max_length=10)),
            ('position', self.gf('django.db.models.fields.CharField')(default='medlem', max_length=10)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='positions', to=orm['authentication.OnlineUser'])),
        ))
        db.send_create_signal(u'authentication', ['Position'])


    def backwards(self, orm):
        # Deleting model 'Position'
        db.delete_table(u'authentication_position')
    ...
    models = {
        ...
        u'authentication.position': {
            'Meta': {'ordering': "(u'user',)", 'object_name': 'Position'},
            'committee': ('django.db.models.fields.CharField', [], {'default': "'hs'", 'max_length': '10'}),
            'end_year': ('django.db.models.fields.CharField', [], {'default': '2014', 'max_length': '4', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_year': ('django.db.models.fields.CharField', [], {'default': '2013', 'max_length': '4'}),
