...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'AllowedUsername', fields ['username']
        db.create_unique(u'authentication_allowedusername', ['username'])

        # Adding unique constraint on 'OnlineUser', fields ['ntnu_username']
        db.create_unique(u'authentication_onlineuser', ['ntnu_username'])


    def backwards(self, orm):
        # Removing unique constraint on 'OnlineUser', fields ['ntnu_username']
        db.delete_unique(u'authentication_onlineuser', ['ntnu_username'])

        # Removing unique constraint on 'AllowedUsername', fields ['username']
        db.delete_unique(u'authentication_allowedusername', ['username'])
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 11, 0, 0)'}),
