...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Email'
        db.create_table(u'authentication_email', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='email_user', to=orm['authentication.OnlineUser'])),
            ('email', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=75)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'authentication', ['Email'])


    def backwards(self, orm):
        # Deleting model 'Email'
        db.delete_table(u'authentication_email')
