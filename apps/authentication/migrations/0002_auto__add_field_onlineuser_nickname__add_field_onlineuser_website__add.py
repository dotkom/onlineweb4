...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OnlineUser.nickname'
        db.add_column(u'authentication_onlineuser', 'nickname',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'OnlineUser.website'
        db.add_column(u'authentication_onlineuser', 'website',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'OnlineUser.image'
        db.add_column(u'authentication_onlineuser', 'image',
                      self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OnlineUser.nickname'
        db.delete_column(u'authentication_onlineuser', 'nickname')

        # Deleting field 'OnlineUser.website'
        db.delete_column(u'authentication_onlineuser', 'website')

        # Deleting field 'OnlineUser.image'
        db.delete_column(u'authentication_onlineuser', 'image')
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 3, 0, 0)'}),
