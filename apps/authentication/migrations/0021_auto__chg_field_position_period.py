...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Position.period'
        db.alter_column(u'authentication_position', 'period', self.gf('django.db.models.fields.CharField')(max_length=9))

    def backwards(self, orm):

        # Changing field 'Position.period'
        db.alter_column(u'authentication_position', 'period', self.gf('django.db.models.fields.CharField')(max_length=4))
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 29, 0, 0)'}),
