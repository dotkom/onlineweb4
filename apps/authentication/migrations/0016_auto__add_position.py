...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'authentication_position', (
            ...
            ('committee', self.gf('django.db.models.fields.CharField')(max_length=100)),
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 26, 0, 0)'}),
        ...
        u'authentication.position': {
            ...
            'committee': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
