...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SpecialPosition'
        db.create_table(u'authentication_specialposition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('position', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('since_year', self.gf('django.db.models.fields.IntegerField')(max_length=4)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='special_positions', to=orm['authentication.OnlineUser'])),
        ))
        db.send_create_signal(u'authentication', ['SpecialPosition'])


    def backwards(self, orm):
        # Deleting model 'SpecialPosition'
        db.delete_table(u'authentication_specialposition')
    ...
    models = {
        ...
        u'authentication.position': {
            'Meta': {'ordering': "('user', 'period')", 'object_name': 'Position'},
            'committee': ('django.db.models.fields.CharField', [], {'default': "'hs'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'period': ('django.db.models.fields.CharField', [], {'default': "'2013-2014'", 'max_length': '9'}),
            'position': ('django.db.models.fields.CharField', [], {'default': "'medlem'", 'max_length': '10'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'positions'", 'to': u"orm['authentication.OnlineUser']"})
        },
        ...
        u'authentication.specialposition': {
            'Meta': {'ordering': "('user', 'since_year')", 'object_name': 'SpecialPosition'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'position': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'since_year': ('django.db.models.fields.IntegerField', [], {'max_length': '4'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'special_positions'", 'to': u"orm['authentication.OnlineUser']"})
        },
