...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authentication', '0033_convert_position_period_to_date'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='position',
            options={'default_permissions': ('add', 'change', 'delete'), 'ordering': ('user', 'period_start', 'period_end'), 'permissions': (('view_position', 'View Position'),), 'verbose_name': 'posisjon', 'verbose_name_plural': 'posisjoner'},
        ),
