...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AllowedUsername'
        db.create_table(u'authentication_allowedusername', (
        ...
        db.send_create_signal(u'authentication', ['AllowedUsername'])


    def backwards(self, orm):
        # Deleting model 'AllowedUsername'
        db.delete_table(u'authentication_allowedusername')
    ...
    models = {
        ...
        u'authentication.allowedusername': {
            'Meta': {'object_name': 'AllowedUsername'},
