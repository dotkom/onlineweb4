...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Email.active'
        db.delete_column(u'authentication_email', 'active')

        # Adding field 'Email.primary'
        db.add_column(u'authentication_email', 'primary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Email.verified'
        db.add_column(u'authentication_email', 'verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Email.active'
        db.add_column(u'authentication_email', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Email.primary'
        db.delete_column(u'authentication_email', 'primary')

        # Deleting field 'Email.verified'
        db.delete_column(u'authentication_email', 'verified')
    ...
    models = {
        ...
        u'authentication.allowedusername': {
            'Meta': {'ordering': "('username',)", 'object_name': 'AllowedUsername'},
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 2, 0, 0)'}),
