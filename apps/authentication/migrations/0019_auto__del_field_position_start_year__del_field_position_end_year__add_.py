...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Position.start_year'
        db.delete_column(u'authentication_position', 'start_year')

        # Deleting field 'Position.end_year'
        db.delete_column(u'authentication_position', 'end_year')

        # Adding field 'Position.period'
        db.add_column(u'authentication_position', 'period',
                      self.gf('django.db.models.fields.CharField')(default=2013, max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Position.start_year'
        db.add_column(u'authentication_position', 'start_year',
                      self.gf('django.db.models.fields.CharField')(default=2013, max_length=4),
                      keep_default=False)

        # Adding field 'Position.end_year'
        db.add_column(u'authentication_position', 'end_year',
                      self.gf('django.db.models.fields.CharField')(default=2014, max_length=4),
                      keep_default=False)

        # Deleting field 'Position.period'
        db.delete_column(u'authentication_position', 'period')
    ...
    models = {
        ...
        u'authentication.position': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'period': ('django.db.models.fields.CharField', [], {'default': '2013', 'max_length': '4'}),
