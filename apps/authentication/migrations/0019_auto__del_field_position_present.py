...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Position.present'
        db.delete_column(u'authentication_position', 'present')


    def backwards(self, orm):
        # Adding field 'Position.present'
        db.add_column(u'authentication_position', 'present',
    ...
    models = {
        ...
        u'authentication.position': {
            ...
            'end_year': ('django.db.models.fields.CharField', [], {'default': '2014', 'max_length': '4'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
