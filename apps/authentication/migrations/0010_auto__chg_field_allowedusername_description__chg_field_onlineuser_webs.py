...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AllowedUsername.description'
        db.alter_column(u'authentication_allowedusername', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'OnlineUser.website'
        db.alter_column(u'authentication_onlineuser', 'website', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'AllowedUsername.description'
        db.alter_column(u'authentication_allowedusername', 'description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'OnlineUser.website'
        db.alter_column(u'authentication_onlineuser', 'website', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        u'authentication.registertoken': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 29, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
