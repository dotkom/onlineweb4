...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OnlineUser.address'
        db.alter_column(u'authentication_onlineuser', 'address', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'OnlineUser.address'
        db.alter_column(u'authentication_onlineuser', 'address', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 3, 0, 0)'}),
        ...
        u'authentication.position': {
            'Meta': {'ordering': "(u'user', u'period')", 'object_name': 'Position'},
