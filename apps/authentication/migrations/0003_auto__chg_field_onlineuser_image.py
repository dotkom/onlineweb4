...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OnlineUser.image'
        db.alter_column(u'authentication_onlineuser', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'OnlineUser.image'
        db.alter_column(u'authentication_onlineuser', 'image', self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True))
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 17, 0, 0)'}),
        ...
        u'authentication.registertoken': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 17, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
