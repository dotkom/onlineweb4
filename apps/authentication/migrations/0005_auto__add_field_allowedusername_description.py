...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AllowedUsername.description'
        db.add_column(u'authentication_allowedusername', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AllowedUsername.description'
        db.delete_column(u'authentication_allowedusername', 'description')
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 7, 0, 0)'}),
        ...
        u'authentication.registertoken': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 7, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
