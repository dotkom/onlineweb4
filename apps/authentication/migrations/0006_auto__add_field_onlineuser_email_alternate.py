...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OnlineUser.email_alternate'
        db.add_column(u'authentication_onlineuser', 'email_alternate',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OnlineUser.email_alternate'
        db.delete_column(u'authentication_onlineuser', 'email_alternate')
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'email_alternate': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
