...
FIELD_OF_STUDY_CHOICES = [
    (0, _('Gjest')),
    (1, _('Bachelor i Informatikk (BIT)')),
    # master degrees take up the interval [10,30]
    (10, _('Programvaresystemer (P)')),
    (11, _('Databaser og søk (DS)')),
    (12, _('Algoritmer og datamaskiner (AD)')),
    (13, _('Spillteknologi (S)')),
    (14, _('Kunstig intelligens (KI)')),
    (15, _('Helseinformatikk (MSMEDTEK)')),
...
class OnlineUser(AbstractUser):
    ...
    saldo = models.PositiveSmallIntegerField(_("saldo"), default=0)
