...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    filebrowser.fields.FileBrowseField(
                        max_length=200, null=True, verbose_name="bilde"
                    ),
                ),
                (
                    "video",
                    models.CharField(
                        max_length=200, verbose_name="vimeo id", blank=True
                    ),
                ),
                (
                    "created_date",
                ...
                (
                    "additional_authors",
                    models.CharField(
                        max_length=200, verbose_name="andre forfattere", blank=True
                    ),
                ),
                (
                    "photographers",
                    models.CharField(
                        max_length=200, verbose_name="fotograf(er)", blank=True
                    ),
                ),
                (
                    "featured",
        ...
        migrations.AlterUniqueTogether(
            name="articletag", unique_together=set([("article", "tag")])
        ),
    ]
