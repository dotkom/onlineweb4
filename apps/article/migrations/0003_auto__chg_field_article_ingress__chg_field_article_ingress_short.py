...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'article_article', 'ingress', self.gf('django.db.models.fields.TextField')(max_length=250))
    ...
    models = {
        u'article.article': {
            ...
            'ingress': ('django.db.models.fields.TextField', [], {'max_length': '250'}),
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 16, 0, 0)'}),
