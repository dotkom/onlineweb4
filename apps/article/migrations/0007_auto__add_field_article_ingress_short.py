...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.ingress_short'
        db.add_column(u'article_article', 'ingress_short',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.ingress_short'
        db.delete_column(u'article_article', 'ingress_short')
