...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.video_id'
        db.delete_column(u'article_article', 'video_id')
    ...
    def backwards(self, orm):
        # Adding field 'Article.video_id'
        db.add_column(u'article_article', 'video_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)
    ...
    models = {
        u'article.article': {
            ...
            'ingress': ('django.db.models.fields.CharField', [], {'max_length': '225'}),
