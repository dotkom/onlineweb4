...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.photographers'
        db.add_column(u'article_article', 'photographers',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Article.photographers'
        db.delete_column(u'article_article', 'photographers')
    ...
    models = {
        u'article.article': {
            ...
            'photographers': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
