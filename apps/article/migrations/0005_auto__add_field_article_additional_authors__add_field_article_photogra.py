...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.additional_authors'
        db.add_column(u'article_article', 'additional_authors',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Article.photographs'
        db.add_column(u'article_article', 'photographs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.additional_authors'
        db.delete_column(u'article_article', 'additional_authors')

        # Deleting field 'Article.photographs'
        db.delete_column(u'article_article', 'photographs')


    models = {
        u'article.article': {
            'Meta': {'ordering': "['published_date']", 'object_name': 'Article'},
            'additional_authors': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            ...
            'photographs': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
