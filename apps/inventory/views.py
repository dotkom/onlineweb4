...
from apps.inventory.serializers import ItemSerializer, UserSerializer, TransactionSerializer
...
class TransactionViewSet(viewsets.GenericViewSet, mixins.RetrieveModelMixin, mixins.ListModelMixin):
