...
urlpatterns = [
    re_path("^$", views.index, name="dashboard_inventory_index"),
    re_path("^discontinued", views.discontinued, name="dashboard_discontinued_index"),
    re_path("^statistics/$", views.statistics, name="dashboard_inventory_statistics"),
    re_path(
        r"^statistics/orders/$",
        views.order_statistics,
        name="dashboard_inventory_order_statistics",
    ),
    re_path("^category/$", views.category_index, name="dashboard_category_index"),
    re_path(
        r"^category/(?P<category_pk>\d+)/$",
        views.category_details,
        name="dashboard_category_details",
    ),
    re_path("^category/new/$", views.category_new, name="dashboard_category_new"),
    re_path(
