...
from apps.marks.models import (Mark, MarkRuleSet, MarkUser, RuleAcceptance,
...
class MarkRuleAcceptanceAPITest(OIDCTestCase):
    ...
    def create_rule_acceptance(self):
        self.rule_acceptance: RuleAcceptance = G(RuleAcceptance, user=self.user, rule_set=self.rule_set)
    ...
    def test_authenticated_user_cannot_view_mark_acceptance_for_other_users(self):
        ...
        rule_acceptance: RuleAcceptance = G(RuleAcceptance, user=other_user, rule_set=self.rule_set)
    ...
    def test_user_can_not_accept_mark_rules_for_other_users(self):
        ...
        rule_acceptance = RuleAcceptance.objects.filter(user=other_user, rule_set=self.rule_set).first()
