...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mark.mark_added_date'
        db.delete_column(u'marks_mark', 'mark_added_date')

        # Adding field 'Mark.added_date'
        db.add_column(u'marks_mark', 'added_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 18, 0, 0)),
                      keep_default=False)

        # Adding field 'Mark.expiration_date'
    ...
    def backwards(self, orm):
        # Adding field 'Mark.mark_added_date'
        db.add_column(u'marks_mark', 'mark_added_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 11, 18, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Mark.added_date'
        db.delete_column(u'marks_mark', 'added_date')
