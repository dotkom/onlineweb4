...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Mark.expiration_date'
        db.delete_column(u'marks_mark', 'expiration_date')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Mark.expiration_date'
        raise RuntimeError("Cannot reverse this migration. 'Mark.expiration_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Mark.expiration_date'
        db.add_column(u'marks_mark', 'expiration_date',
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 1, 21, 0, 0)'}),
