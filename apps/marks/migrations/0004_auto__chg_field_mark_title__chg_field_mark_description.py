...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mark.title'
        db.alter_column(u'marks_mark', 'title', self.gf('django.db.models.fields.CharField')(max_length=155))

        # Changing field 'Mark.description'
        db.alter_column(u'marks_mark', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Mark.title'
        db.alter_column(u'marks_mark', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Mark.description'
        db.alter_column(u'marks_mark', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))
