...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content",
                    models.TextField(
                        help_text="Regelsett skrevet i markdown", verbose_name="Regler"
                    ),
                ),
                (
                    "version",
                    models.CharField(
                        max_length=128, unique=True, verbose_name="Versjon"
                    ),
                ),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name="ruleacceptance", unique_together={("user", "rule_set")}
        ),
    ]
