...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.allergies'
        db.alter_column('userprofile_userprofile', 'allergies', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.allergies'
        db.alter_column('userprofile_userprofile', 'allergies', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        'userprofile.userprofile': {
            ...
            'started_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 9, 0, 0)'}),
