...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'userprofile_userprofile', 'nickname',
        ...
        # Adding field 'Privacy.visible_for_other_users'
        db.add_column(u'userprofile_privacy', 'visible_for_other_users',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'userprofile_userprofile', 'nickname')

        # Deleting field 'UserProfile.website'
        db.delete_column(u'userprofile_userprofile', 'website')

        # Deleting field 'Privacy.visible_for_other_users'
        db.delete_column(u'userprofile_privacy', 'visible_for_other_users')
    ...
    models = {
        ...
        u'userprofile.userprofile': {
            ...
            'started_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 12, 0, 0)'}),
