...
urlpatterns = [
    ...
    path('album/<int:album_pk>/photo/new', views.PhotoCreate.as_view(), name='photo_new'),
    path('album/<int:album_pk>/photo/<int:pk>/update', views.PhotoUpdate.as_view(), name='photo_update'),
    path('album/<int:album_pk>/photo/<int:pk>/delete', views.PhotoDelete.as_view(), name='photo_delete'),
]
