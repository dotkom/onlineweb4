...
urlpatterns = [
    re_path("^$", views.GalleryIndex.as_view(), name="index"),
    re_path(r"^(?P<pk>\d+)/$", views.GalleryDetail.as_view(), name="detail"),
    re_path("^upload/$", views.GalleryUpload.as_view(), name="upload"),
    re_path(r"^(?P<pk>\d+)/delete/$", views.GalleryDelete.as_view(), name="delete"),
    re_path("^unhandled/$", views.GalleryUnhandledIndex.as_view(), name="unhandled"),
    re_path(
