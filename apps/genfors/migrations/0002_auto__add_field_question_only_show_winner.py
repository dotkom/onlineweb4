...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.only_show_winner'
        db.add_column(u'genfors_question', 'only_show_winner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.only_show_winner'
        db.delete_column(u'genfors_question', 'only_show_winner')
