...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbstractVoter.timestamp'
        db.add_column(u'genfors_abstractvoter', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 19, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AbstractVoter.timestamp'
        db.delete_column(u'genfors_abstractvoter', 'timestamp')
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 19, 0, 0)'}),
