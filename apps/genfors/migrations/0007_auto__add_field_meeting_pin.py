...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meeting.pin'
        db.add_column(u'genfors_meeting', 'pin',
                      self.gf('django.db.models.fields.CharField')(default='stub', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meeting.pin'
        db.delete_column(u'genfors_meeting', 'pin')
