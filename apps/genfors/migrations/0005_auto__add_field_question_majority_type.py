...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.majority_type'
        db.add_column(u'genfors_question', 'majority_type',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.majority_type'
        db.delete_column(u'genfors_question', 'majority_type')
