...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Result'
        db.create_table(u'genfors_result', (
            ...
            ('result_public', self.gf('django.db.models.fields.TextField')(max_length=2000)),
            ('result_private', self.gf('django.db.models.fields.TextField')(max_length=2000)),
        ))
        db.send_create_signal(u'genfors', ['Result'])


    def backwards(self, orm):
        # Deleting model 'Result'
        db.delete_table(u'genfors_result')
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 29, 0, 0)'}),
        ...
        u'genfors.result': {
            ...
            'meeting': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['genfors.Meeting']"}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['genfors.Question']"}),
            'result_private': ('django.db.models.fields.TextField', [], {'max_length': '2000'}),
            'result_public': ('django.db.models.fields.TextField', [], {'max_length': '2000'})
        }
    }
