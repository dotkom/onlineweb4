    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(
                        max_length=50, null=True, verbose_name="Beskrivelse", blank=True
                    ),
                ),
                ("stock", models.PositiveSmallIntegerField(null=True, blank=True)),
                (
                    "product",
                    models.ForeignKey(to="webshop.Product", on_delete=models.CASCADE),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                related_name="orders", to="webshop.OrderLine", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="order",
